...
public class BacktrackingLCVSolver implements CSPSolver{
...
//        for (int i=0;i<csp.domains.get(var).size();i++){
//            if (value!=csp.domains.get(var).get(i)){
//                set.add(csp.domains.get(var).get(i));
//            }
//        }
